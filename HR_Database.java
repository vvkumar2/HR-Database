...
public class HR_Database
{
    public static void main (String [] args) throws IOException
    {
        ...
        System.out.println("If " + compName + " pays some employees on commission, what is the rate in decimal form?");
        double rate = stan.nextDouble();
        stan.nextLine();
        ...
        System.out.println();
        System.out.println("Would you like to save this list as a file (yes or no) ");
        ...
        if(a.equals("yes"))
            {
                ...
                myWriter.write(str1);
                myWriter.close();
                System.out.println("Database has been saved in file named List.TXT");
            }
        System.out.println();
        ...
        while(totaltype == 1)
        {
            ...
            while(type!=5)
            {
                ...
                if(type == 4)
                {
                    ...
                    {
                        System.out.println(e.getName() + "'s sales: " + e.getSales());
                        System.out.println(e.getName() + "'s commisions: " + e.getCommission());
                    }
                    System.out.println();
                    System.out.println("Would you like to edit the salary, position, name, or sales");
            ...
            if(b.equals("yes"))
            {
                ...
                myWriter.write(str1);
                myWriter.close();
                System.out.println("Database has been saved in file named updatedList.TXT");
            }
